...
locals {
  ...
  instance_zone       = local.is_production ? var.preferred_zone : var.feature_preferred_zone
  redis_machine_type  = local.is_production ? var.redis_machine_type : var.feature_persistence_machine_type
}
