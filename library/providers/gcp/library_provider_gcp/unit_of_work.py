...
async def gcp_unit_of_work() -> AsyncGenerator[None]:
    ...
    try:
        ...
        _transaction.set(old_uow)


def get_current_gcp_transaction() -> UOW:
    uow = _transaction.get()
    if uow is None:
        raise InfrastructureError(
